...
[![npm](https://img.shields.io/npm/v/@io-swap/token-list)](https://unpkg.com/@io-swap/token-list@latest/)
...
```typescript
import { TokenList, schema } from '@io-swap/token-list'
